...
//分页指令
angularApp.directive('tmPagination',[function(){
    return {
        restrict: 'EA',
...
angularApp.directive('test',[function() {
    return {
        restrict: 'EA',
        replace: true,
        template: '<div><h1>计算结果{{sum}}</h1><div class="btn btn-default" ng-click="aaa()">test</div></div>',
        scope: {
            conf: '='
        },
        link: function(scope, element, attrs) {
